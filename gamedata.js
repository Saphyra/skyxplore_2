    ...
    try
    {
        var gamedata = 
        {
            ...
            items:
            {
                ...
                cri01: new ship("cri01", "cri", "CRI01 - Andromeda", 1, 1000, 1000, 3000, 9000, 40000, 4, 1, 2, 1, 3, 1, 4, 1, 3, 1, 6, 1, 3, 1, 1, 1, 1, 1, 0, 0, 10, 3000),
                ...
                sqa01: new squadron("sqa01", "SQO01 - Grasshopper", 1, 500, 500, 1500, 4500, 2000, 2, 1, 3, 1, 2, 1, 2, 1, 50),
                sqa02: new squadron("sqa02", "SQO02 - Mantis", 2, 750, 750, 2250, 6750, 3500, 4, 2, 6, 2, 4, 2, 4, 2, 150),
                sqa03: new squadron("sqa03", "SQO03 - Ant", 3, 1000, 1000, 3000, 9000, 5500, 6, 3, 9, 3, 6, 3, 6, 3, 400),
                sqa04: new squadron("sqa04", "SQO04 - Dragonfly", 4, 1500, 1500, 4500, 13500, 8000, 8, 4, 12, 4, 8, 4, 8, 4, 600),
                sqa05: new squadron("sqa05", "SQO05 - Moth", 5, 2000, 2000, 6000, 18000, 11000, 10, 5, 15, 5, 10, 5, 10, 5, 900),
                sqa06: new squadron("sqa06", "SQO06 - Mosquitoe", 6, 2500, 2500, 7500, 22500, 15000, 12, 6, 18, 6, 12, 6, 12, 6, 1500),
                sqa07: new squadron("sqa07", "SQO07 - Wasp", 7, 3000, 3000, 9000, 27000, 22000, 14, 7, 21, 7, 14, 7, 14, 7, 2500),
                sqa08: new squadron("sqa08", "SQO08 - Tarantula", 8, 3500, 3500, 10500, 31500, 35000, 16, 8, 24, 8, 16, 8, 16, 8, 4500),
                sqa09: new squadron("sqa09", "SQO09 - Scorpion", 9, 4000, 4000, 12000, 36000, 50000, 18, 9, 27, 9, 18, 9, 18, 9, 7000),
                sqa10: new squadron("sqa10", "SQO10 - Black Widow", 10, 5000, 5000, 15000, 45000, 75000, 20, 10, 30, 10, 20, 10, 20, 10, 10000),
                ...
                sqh01: new squadronhull("sqh01", "SQH01 - Rahburkolat Mk.I", 1, 200, 200, 600, 1800, 1000),
                sqh02: new squadronhull("sqh02", "SQH02 - Rahburkolat Mk.II", 2, 300, 300, 900, 2700, 2000),
                sqh03: new squadronhull("sqh03", "SQH03 - Rahburkolat Mk.III", 3, 400, 400, 1200, 3600, 3000),
                sqh04: new squadronhull("sqh04", "SQH03 - Rahburkolat Mk.IV", 4, 500, 500, 1500, 4500, 4000),
                sqh05: new squadronhull("sqh05", "SQH04 - Rahburkolat Mk.V", 5, 700, 700, 2100, 6300, 5000),
                sqh06: new squadronhull("sqh06", "SQH05 - Rahburkolat Mk.VI", 6, 900, 900, 2700, 8100, 6000),
                sqh07: new squadronhull("sqh07", "SQH06 - Rahburkolat Mk.VII", 7, 1100, 1100, 3300, 9900, 7000),
                sqh08: new squadronhull("sqh08", "SQH07 - Rahburkolat Mk.VIII", 8, 1400, 1400, 4200, 12600, 8000),
                sqh09: new squadronhull("sqh09", "SQH08 - Rahburkolat Mk.IX", 9, 1700, 1700, 5100, 15300, 9000),
                sqh10: new squadronhull("sqh10", "SQH10 - Rahburkolat Mk.X", 10, 2000, 2000, 6000, 1800, 10000),
